...
class AppColors {
  ...
  static const Color textPurpleLight = Color(
    0xFFC8B3CE,
  ); // 說明文字（Reward subtitle）
...
class AppButtonStyles {
  ...
  static ButtonStyle secondary = OutlinedButton.styleFrom(
    ...
    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24)),
    side: BorderSide(
      color: AppColors.textCreamWarm.withValues(alpha: 0.3),
      width: 1.5,
    ),
  ...
  static ButtonStyle timerPill({bool isActive = false}) {
    return ElevatedButton.styleFrom(
      foregroundColor: isActive ? const Color(0xFFE8D0F0) : AppColors.textCream,
...
class AppTypography {
  ...
  /// 使用 google_fonts 套件載入 'Press Start 2P'
  static TextStyle get splashTitle => GoogleFonts.pressStart2p(
    fontSize: 32,
    color: AppColors.textCreamGold,
    shadows: const [Shadow(color: Color(0x80FFD700), blurRadius: 20)],
  );

  static TextStyle get rewardTitle => GoogleFonts.pressStart2p(
    fontSize: 24,
